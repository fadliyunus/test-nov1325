                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="nm_siswa" class="form-control @error('nm_siswa') is-invalid
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="nm_ayah" class="form-control @error('nm_ayah') is-invalid
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="nm_ibu" class="form-control @error('nm_ibu') is-invalid
